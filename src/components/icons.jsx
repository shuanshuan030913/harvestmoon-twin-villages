...
const SYMBOLS = {
  ...
  // 依地點查詢入口用（U33，2026-07-21）：地圖釘
  pin: (
    <>
      <path d="M12 21s-6.5-6.1-6.5-11.2A6.5 6.5 0 0112 3.3a6.5 6.5 0 016.5 6.5C18.5 14.9 12 21 12 21z" />
      <circle cx="12" cy="9.8" r="2.2" />
    </>
  ),
  // items（跨系統雜項物品）首頁入口用：木箱
  box: (
    <>
      <path d="M4 8.5L12 5l8 3.5v8L12 20l-8-3.5z" />
      <path d="M4 8.5L12 12l8-3.5M12 12v8" />
    </>
  ),
  // 展開/收合開關用（U36，2026-07-22）：取代裸文字「▲/▼」——後者跟 CJK 文字混排
  // 基線對不齊，看起來歪；用 rotate-180 class 表達開/關兩態。
  chevron: <path d="M6 9l6 6 6-6" />,
  // 存檔頁「匯出／匯入」區塊標題用（2026-07-22 使用者回饋 UI 陽春後新增）：
  // 箭頭插入托盤，存檔/下載的通用語意，圖示庫原本沒有對應圖示。
  save: (
    <>
      <path d="M12 3.5v11" />
  ...
  // 刪除動物觸發鈕用（U62，2026-07-23）：垃圾桶，取代裸「×」字——使用者裁決
  // 拿掉圓形描邊容器後，×字容易讀成「關閉」，垃圾桶圖示語意更直接對應「刪除」。
  trash: (
    <>
      <path d="M5 7h14" />
      <path d="M9.5 7V5a1 1 0 011-1h3a1 1 0 011 1v2" />
      <path d="M7 7l1 12.2a1 1 0 001 1h6a1 1 0 001-1L17 7" />
